...
export class DataProvider extends React.Component {
    ...
    render(){
        const {data, cart, account, coupons, home, darkTheme} = this.state
        const {addToCart, removeFromCart, deleteFromCart, toggleTheme} = this

        return(
            <DataContext.Provider value={{data, cart, account, coupons, home, darkTheme, addToCart, removeFromCart, deleteFromCart, toggleTheme}}>
                {this.props.children}
